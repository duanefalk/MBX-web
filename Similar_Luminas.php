...
<div class="row">
	<div class="large-12 columns">
		...
		<ul class="large-block-grid-2 small-block-grid-2">
			<li><img src="images/similar_models/RC Lumina_1.jpg"></li>
			<li><img src="images/similar_models/RC Lumina_2.jpg"></li>
		</ul>
		<hr />
		...
		<ol>
			...
			<li>Also on the front, Lumina is inscribed, as it is with MB221 (SF0360), but the groove directly above it is interrupted with 2 thin rectangular pockets.</li>
			<li>The side of the car is sculpted with a sleeker look than the later Luminas</li>
		...
		<ul class="large-block-grid-3 small-block-grid-3">
			<li><img src="images/similar_models/MAN 224_1.jpg"></li>
			<li><img src="images/similar_models/MAN 224_2.jpg"></li>
			<li><img src="images/similar_models/MAN 224_3.jpg"></li>
		</ul>
		<hr />
		...
		<ol>
			...
			<li>The bottom of the rear spoiler has a triangular shape</li>
		...
		<ul class="large-block-grid-3 small-block-grid-3">
			<li><img src="images/similar_models/MAN 221_1.jpg"></li>
			<li><img src="images/similar_models/MAN 221_2.jpg"></li>
			<li><img src="images/similar_models/MAN 221_3.jpg"></li>
		</ul>
		<hr />

		<h4>MB267 (SF0396)</h4>
		<ol>
			<li>No Lumina inscribed in the front flange. The bottom flange is completely flat, with no rectangular indentations</li>
			<li>There is only one groove in the front</li>
			<li>The bottom of the rear spoiler has a more rounded contour</li>
			<li>Base details differ considerable. The Matchbox logo has a squashed (left to right) look, and is located in the upper left part of the base</li>
		</ol>
		<ul class="large-block-grid-3 small-block-grid-3">
			<li><img src="images/similar_models/MAN 267_1.jpg"></li>
			<li><img src="images/similar_models/MAN 267_2.jpg"></li>
			<li><img src="images/similar_models/MAN 267_3.jpg"></li>
		</ul>
	</div>
</div>
