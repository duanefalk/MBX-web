	...
	<div class="large-12 columns">
		...
		<?php
		    if (isset($_POST['rel_coll_submit'])) {
		        ...
		        $query="INSERT INTO Matchbox_Collection (Username, User_Coll_ID, UMID, VerID, VarID, RelID, User_SpecID, Copy, VehCond, PkgCond, ItemVal, StorLoc, StorLoc2, PurchDt, Seller, PurchPrice, SellFlag, MinSellPrice, CollComm, Coll_InactiveFlg) VALUES ('$User','$User_Coll_ID','$UMID','$VerID', '$VarID', '$RelID', '$User_SpecID', '$Copy', '$VehCond', '$PkgCond', '$ItemVal', '$StorLoc', '$StorLoc2', '$PurchDt', '$Seller', '$PurchPrice', '$SellFlg', '$MinSellPric', '$CollComm', '$Coll_InactiveFlg')";
		...
		<form name="Add_Rel_to_Coll" action="Add_Rel_to_Coll.php" method="post">	
            ...
            <input type="checkbox" name="CollSellFlg" id="CollSellFlg">
