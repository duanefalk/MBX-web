<?php
	...
	$pageDescription = "Search your own Matchbox University car collection.";
...
<form action="collection-report-m-process.php" method="post">
	...
	<div class="row">
	    ...
	    <div class="large-4 columns">
	        ...
	        <div class="formRow">
	            <input type="radio" name="Sort1" id="Sort1" value="UMID" checked>
	            <label>UMID#</label>	            
	        </div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="MAN">
				<label>MAN#</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="Mack">
				<label>Mack#</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="Location">
				<label>Seller</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="Seller">
				<label>Location</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="MdlValue">
				<label>Value</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="PurchPrice">
				<label>Purchase Price</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort1" id="Sort1" value="PurchDt">
				<label>Purchase Date</label>
			</div>
			
			<h4 class="demoHeaders">Sort Criterion 2</h4>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="UMID" checked>
				<label>UMID#</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="MAN">
				<label>MAN#</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="Mack">
				<label>Mack#</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="Seller">
				<label>Seller</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="Location">
				<label>Location</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="MdlValue">
				<label>Value</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="PurchPrice">
				<label>Purchase Price</label>
			</div>
			<div class="formRow">
				<input type="radio" name="Sort2" id="Sort2" value="PurchDt">
				<label>Purchase Date</label>
			</div>
	    </div>    
	</div>
