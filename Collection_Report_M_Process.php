				...
				if ($_POST['UMID_1']) {
					...
					if (!$_POST['UMID_2']) {
						$query_select="SELECT Matchbox_Collection.Username, Matchbox_Collection.UMID, Matchbox_Collection.VerID, Matchbox_Collection.VarID, Matchbox_Collection.Copy, Matchbox_Collection.VehCond, Matchbox_Collection.ItemVal,
							...
							Matchbox_Variations.UMID, Matchbox_Variations.VerID, Matchbox_Variations.VarID,  Matchbox_Variations.ManufLoc, Matchbox_Variations.FWhCd, Matchbox_Variations.RWhCd, Matchbox_Variations.WindowColor, Matchbox_Variations.InteriorColor,
